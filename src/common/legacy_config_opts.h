...
// also works to enforce fairness between
// clients. "mclock_client_profile" allows each client to define
// multiple dmclock profiles, each with its own dmclock parameters,
// and attach a profile to each op. "debug_random" chooses among all
// four with equal probability.
