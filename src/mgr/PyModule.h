...
std::string_view py_bytes_as_sv(PyObject*);
PyObject *py_bytes_from_sv(std::string_view);

std::string py_bytes_as_s(PyObject*);
PyObject *py_bytes_from_s(const std::string &);
