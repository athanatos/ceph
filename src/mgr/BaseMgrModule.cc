...
ceph_dispatch_remote(BaseMgrModule *self, PyObject *args)
{
  ...
  std::string_view pickled_args_sv = py_bytes_as_sv(pickled_args);
  ...
  std::string_view pickled_kwargs_sv = py_bytes_as_sv(pickled_kwargs);
  ...
  std::string err;
  std::optional<std::string> maybe_pickled_ret =
  ...
  auto pickled_ret_bytes = py_bytes_from_s(*maybe_pickled_ret);
