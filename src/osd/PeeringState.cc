 ...
 *
 * Choose an acting set using as much as up as possible filling in the
 * remaining slots so as to maximize the number of crush buckets at
  ...
  ostream &ss)
{
   ...
   * possible while respecting up, the primary selection, the pool size,
