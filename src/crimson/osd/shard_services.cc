...
seastar::future<Ref<PG>> PerShardState::make_pg(
...
seastar::future<Ref<PG>> PerShardState::handle_pg_create_info(
  ShardServices &shard_services,
...
seastar::future<Ref<PG>>
PerShardState::get_or_create_pg(
  ShardServices &shard_services,
...
seastar::future<Ref<PG>> PerShardState::wait_for_pg(
...
seastar::future<Ref<PG>> PerShardState::load_pg(
  ShardServices &shard_services,
  spg_t pgid)
{
