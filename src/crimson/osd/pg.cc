...
void PG::init(
  ceph::os::CyanStore::CollectionRef coll,
  int role,
...
void PG::handle_advance_map(
  cached_map_t next_map, PeeringState::PeeringCtx &rctx)
{
...
void PG::handle_activate_map(PeeringState::PeeringCtx &rctx)
{
  peering_state.activate_map(rctx);
}

void PG::handle_initialize(PeeringState::PeeringCtx &rctx)
{
  PeeringState::Initialize evt;
  peering_state.handle_event(evt, &rctx);
}
