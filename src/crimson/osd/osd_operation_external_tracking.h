...
struct LttngBackend
  : ClientRequest::StartEvent::Backend,
    ...
    ClientRequest::PGPipeline::RecoverMissingLockOBC::BlockingEvent::ExitBarrierEvent::Backend,
    ...
    ClientRequest::CompletionEvent::Backend
{
  ...
  void handle(ClientRequest::PGPipeline::RecoverMissingLockOBC::BlockingEvent::ExitBarrierEvent& ev,
