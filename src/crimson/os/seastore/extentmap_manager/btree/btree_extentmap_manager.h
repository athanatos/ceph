...
class BtreeExtentMapManager : public ExtentMapManager {
  ...
  insert_lextent_ret insert_lextent(
    extmap_root_t &extmap_root,
    Transaction &t,
    ExtMapNodeRef extent,
    objaddr_t lo,
    lext_map_val_t val);
...
public:
  ...
  initialize_extmap_ret initialize_extmap(
    Transaction &t) final;

  find_lextent_ret find_lextent(
    const extmap_root_t &extmap_root,
    Transaction &t,
    objaddr_t lo,
    extent_len_t len) final;

  add_lextent_ret add_lextent(
    extmap_root_t &extmap_root,
    Transaction &t,
    objaddr_t lo,
    lext_map_val_t val) final;

  rm_lextent_ret rm_lextent(
    extmap_root_t &extmap_root,
    Transaction &t,
    objaddr_t lo,
    lext_map_val_t val) final;
