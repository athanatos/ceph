...
public:
  ...
  CachedExtentRef get_next_dirty_extent() final;

  using SegmentCleaner::ExtentCallbackInterface::get_next_live_extents_ret;
  get_next_live_extents_ret get_next_live_extents(
    paddr_t after) final;
